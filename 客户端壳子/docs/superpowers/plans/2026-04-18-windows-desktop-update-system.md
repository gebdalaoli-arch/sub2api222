...
- 桌面客户端已有：
  - Windows 安装包脚本 [build-desktop-installer.ps1](D:/挣钱/token/token客户端/客户端壳子/build-desktop-installer.ps1)
  - Inno Setup 脚本 [desktop-client.iss](D:/挣钱/token/token客户端/客户端壳子/desktop-client/packaging/windows/desktop-client.iss)
