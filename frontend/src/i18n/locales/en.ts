export default {
  ...
  admin: {
    ...
    users: {
      ...
      tokenAmountRequired: 'Please enter a token amount greater than 0',
      tokenUnit: 'Token',
      withdrawAll: 'All',
      currentBalance: 'Current Balance',
      ...
      newBalance: 'New Balance',
      newTokenBalance: 'New Token Balance',
      tokenGroup: 'Token Group',
      noTokenGroupAvailable: 'No desktop token-settlement group is available. Bind a token settlement group in channel management first.',
      failedToLoadTokenBalance: 'Failed to load token wallet summary',
    ...
    redeem: {
      ...
      selectTokenGroup: 'Select Client Group',
      selectTokenGroupPlaceholder: 'Choose the desktop-client group',
      validityDays: 'Validity Days',
      groupRequired: 'Please select a subscription group',
      tokenGroupRequired: 'Please select the desktop client group to credit',
      tokenAmountRequired: 'Please enter a token amount greater than 0',
      days: ' days',
      status: {
        unused: 'Unused',
