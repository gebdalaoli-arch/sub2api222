export default {
  ...
  admin: {
    ...
    users: {
      ...
      deposit: '充值',
      withdraw: '退款',
      depositToken: '充值 Token',
      withdrawToken: '扣减 Token',
      depositAmount: '充值金额',
      withdrawAmount: '退款金额',
      tokenAmount: 'Token 数量',
      tokenAmountRequired: '请输入大于 0 的 Token 数量',
      tokenUnit: 'Token',
      withdrawAll: '全部',
      currentTokenBalance: '当前 Token 余额',
      ...
      amountHint: '请输入正数金额',
      newBalance: '操作后余额',
      newTokenBalance: '操作后 Token 余额',
      tokenGroup: 'Token 分组',
      noTokenGroupAvailable: '当前没有可用于桌面客户端 Token 钱包的分组，请先在渠道管理中绑定 token 结算分组。',
      failedToLoadTokenBalance: '加载 Token 钱包失败',
    ...
    redeem: {
      ...
      selectTokenGroup: '选择客户端分组',
      selectTokenGroupPlaceholder: '选择桌面客户端专用分组',
      validityDays: '有效天数',
      groupRequired: '请选择订阅分组',
      tokenGroupRequired: '请选择要入账的桌面客户端分组',
      tokenAmountRequired: '请输入大于 0 的 Token 数量',
      days: '天',
      status: {
        unused: '未使用',
      ...
      noCodes: '暂无兑换码',
      noCodesDescription: '生成兑换码以向用户分发 Token、余额或并发数。',
