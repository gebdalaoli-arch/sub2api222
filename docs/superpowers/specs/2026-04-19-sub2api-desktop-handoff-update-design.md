...
- 从 [desktop-client/src/main.rs](D:/挣钱/token/token客户端/desktop-client/src/main.rs) 开始的事件接线
- [desktop-client/src/platform/launcher.rs](D:/挣钱/token/token客户端/desktop-client/src/platform/launcher.rs) 的官方 / 平台启动差异
- [desktop-client/src/platform/runtime_bootstrap.rs](D:/挣钱/token/token客户端/desktop-client/src/platform/runtime_bootstrap.rs) 的虚拟机兼容处理
