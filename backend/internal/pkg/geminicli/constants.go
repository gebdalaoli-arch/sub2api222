...
const (
	...
	// GeminiCLIOAuthClientID is the built-in public OAuth client ID used by Google Gemini CLI.
	// The matching client_secret must be injected at runtime via GEMINI_CLI_OAUTH_CLIENT_SECRET.
