...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, desktopAuth, apiKeyService, tokenBillingService, subscriptionService, opsService, settingService, cfg, redisClient)
}
